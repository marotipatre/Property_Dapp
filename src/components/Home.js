...
const Home = ({ home, provider,account, escrow, toggleProp }) => {
    ...
    const fetchDetails = async () => {
        ...
        const hasInspected = await escrow.inspectionCheck(home.id)
    ...
    const inspectHandler = async () => {
        ...
        const transaction = await escrow.connect(signer).updatesinspection(home.id, true)
        await transaction.wait()
